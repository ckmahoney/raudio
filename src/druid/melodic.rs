...
pub fn dress_square(freq: f32) -> Dressing {
...
mod test {
  ...
  fn test_blend_single_element_square() {
    ...
    let elementor: Elementor = vec![(1f32, nearly_none_square)];
  ...
  fn test_blend_single_element_triangle() {
    ...
    let (vis, en, pre) = test_vep();
    let elementor: Elementor = vec![(1f32, nearly_none_triangle)];
  ...
  fn test_blend_single_element_sawtooth() {
    ...
    let (vis, en, pre) = test_vep();
    let elementor: Elementor = vec![(1f32, nearly_none_sawtooth)];
