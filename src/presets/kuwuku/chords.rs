...
fn amp_knob_noise() -> (Knob, fn(&Knob, f32, f32, f32, f32, f32) -> f32) {
    ...
    (Knob { a: sustain, b: decay_mode, c: time_scaling_enabled }, ranger::amod_microtransient_4_20)
...
pub fn renderable<'render>(melody:&'render Melody<Note>, arf:&Arf) -> Renderable<'render> {
    ...
    let stem_noise = (melody, soids_noise, expr, feel_noise, knob_mods_noise, vec![delay::passthrough]);
    ...
    let stem_tonal = (melody, soids_tonal, expr, feel_tonal, knob_mods_tonal, vec![delay::passthrough]);
