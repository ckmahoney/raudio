...
fn amp_knob_monic_delay(visibility:Visibility, energy:Energy, presence:Presence) -> (Knob, fn(&Knob, f32, f32, f32, f32, f32) -> f32) {
    ...
    (Knob { a: env_length, b: dynamic_range, c: multiplier_rate }, ranger::amod_fadein)
}
